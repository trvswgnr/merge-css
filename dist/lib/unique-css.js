...
exports.getUniqueNodes = exports.uniqueCss = void 0;
...
function uniqueCss(targetCss, otherCss) {
    const target = postcss_1.default.parse(targetCss);
    const other = postcss_1.default.parse(otherCss);
    target.cleanRaws();
    other.cleanRaws();
...
exports.getUniqueNodes = getUniqueNodes;
exports.default = uniqueCss;
